...
export function ChatAppSettingsPanel({ app }: AppSettingsPanelProps) {
    ...
    <div className="space-y-5">
      <div className="space-y-2">
        ...
        <textarea
          ...
          placeholder="Keep answers concise; prefer code-first suggestions."
          disabled={isLoading}
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          placeholder="E.g., “Review this repository and suggest quick fixes.”"
          disabled={isLoading}
        />
      </div>
